...
// auth
import MenuBuilder from '../pages/super-admin/menu-builder';
    ...
    // Dashboard
    {
      ...
      children: [
        ...
        },
        {
          path: 'master',
          children: [
            { element: <Navigate to="/dashboard/master/institute/list" replace />, index: true },
            { path: 'institute/list', element: <InstituteList /> },
            { path: 'institute/add', element: <InstituteAdd /> },
            { path: 'institute/:id/edit', element: <InstituteEdit /> },
            { path: 'class/list/:id', element: <ClassList /> }
          ],
        },
        // {
        //   path: 'class',
