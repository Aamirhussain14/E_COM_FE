...
// INSTITUTE ROUTES
export const InstituteList = Loadable(lazy(() => import('../pages/my_component/master/institute/index')));
export const InstituteAdd = Loadable(lazy(() => import('../pages/my_component/master/institute/InstituteAdd')));
export const InstituteEdit = Loadable(lazy(() => import('../pages/my_component/master/institute/InstituteEdit')));

// CLASS-SECTION ROUTES
export const ClassList = Loadable(lazy(() => import('../pages/my_component/master/class-section/ClassList')));
